...
The function will read the parameters from the WSTBlobData 'CyberCNSAPI/Settings'.

Returns the headers to use in subsequent calls if successful, $null if the connection was not successful.
